// MODIFIED BY DOMINIC HUNTER ON 10/13/20
// Changed a line of code from "var uvs = texture_get_uvs(_sur);" to "var uvs = texture_get_uvs(_tex);" on reccomendation from a review of this module, in order to prevent a game-crashing bug that occurs when you free the selected surface
